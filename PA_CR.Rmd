    ...
    for (t in f[i]:(n_year-1)) {
      ...
      logit(p[i, t]) <- lambda[1] +
        lambda[2] * (mSpUnk[i] * (1 - Sex[i]) +                                                 # all NA females
                       mSpUnk[mother[i]] * Sex[i] * (Age0[i, t+1] + Age1[i, t+1]+ Age2[i, t+1])) + # all male dependent cubs of NA females
        lambda[3] * (mSpPel[i] * (1 - Sex[i]) +                                                 # all pelagic females
                       mSpPel[mother[i]] * Sex[i] * (Age0[i, t+1] + Age1[i, t+1] + Age2[i, t+1])) + # all male dependent cubs of pelagic females
